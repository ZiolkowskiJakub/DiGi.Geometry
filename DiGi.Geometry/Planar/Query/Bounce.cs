...
namespace DiGi.Geometry.Planar
{
    public static partial class Query
    {
        ...
        /// </summary>
        /// <param name="vector2D_ToBeBounced">The <see cref="Vector2D?"/> representing the velocity or direction to be bounced.</param>
        ...
        /// <returns>The resulting <see cref="Vector2D?"/> after the bounce calculation, or <see langword="null"/> if either the input vector or segment is <see langword="null"/>.</returns>
