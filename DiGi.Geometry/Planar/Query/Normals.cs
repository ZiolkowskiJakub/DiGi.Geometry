...
namespace DiGi.Geometry.Planar
{
    public static partial class Query
    {
        ...
        /// <returns>A <c>List&lt;Vector2D?&gt;</c> containing the normal vectors, or <c>null</c> if the <see cref="IPolygonal2D"/> is null, contains invalid segments, or has a collinear or undefined orientation.</returns>
