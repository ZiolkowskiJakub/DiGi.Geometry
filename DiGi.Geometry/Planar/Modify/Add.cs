...
namespace DiGi.Geometry.Planar
{
    ...
    {
        /// <summary>
        /// Adds a <see cref="Point2D?"> to the <see cref="List{Point2D?}?"> if it is not null and does not already exist within the specified tolerance.
        /// </summary>
        /// <param name="point2Ds">The <see cref="List{Point2D?}?"> to which the point will be added.</param>
        /// <param name="point2D">The <see cref="Point2D?"> object to add to the list.</param>
