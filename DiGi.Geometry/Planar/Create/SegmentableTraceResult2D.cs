...
namespace DiGi.Geometry.Planar
{
    public static partial class Create
    {
        ...
        /// <returns>The first <see cref="SegmentableTraceResult2D"/> found, or null if no intersection occurs within the specified tolerance.</returns>
        ...
        /// <returns>The first <see cref="SegmentableTraceResult2D"/> found, or null if no result exists.</returns>
