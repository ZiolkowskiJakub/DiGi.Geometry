...
namespace DiGi.Geometry.Planar
{
    ...
    {
        /// <summary>
        /// Creates a list of <see cref="PolygonalFace2D"/> objects from a collection of <see cref="Segment2D"/> segments.
        /// </summary>
        ...
        /// <returns>A <see cref="List{T}"/> of <see cref="PolygonalFace2D"/> objects if successful; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Converts a collection of <see cref="IPolygonal2D"/> objects to a list of <see cref="PolygonalFace2D"/> objects.
        /// </summary>
        ...
        /// <returns>A <see cref="List{T}"/> of <see cref="PolygonalFace2D"/> objects, or <see langword="null"/> if the input collection is <see langword="null"/>.</returns>
