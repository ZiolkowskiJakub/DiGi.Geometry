...
namespace DiGi.Geometry.Spatial
{
    ...
    {
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> from a collection of <see cref="Point3D"/> objects.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> object if a valid polygon can be created; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> from the specified normal vector and a collection of 3D points.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> if a valid polygon can be constructed; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> from the specified <see cref="Segment3D"/> with a given height.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> instance, or null if the <see cref="Segment3D"/> is null, height is NaN, or the segment direction is parallel to the WorldZ axis within the specified tolerance.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> from a <see cref="Segment3D"/> and a <see cref="Vector3D"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> if a valid polygon can be created; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Converts a planar object to a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> if the <see cref="IPlanar{T}"/> object, its geometry, and its plane are not null; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> instance based on the provided <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> and a collection of <see cref="Point2D"/> points.
        /// </summary>
        /// <param name="plane">The <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> that defines the surface of the polygon.</param>
        /// <param name="point2Ds">A variable number of <see cref="Point2D"/> objects representing the vertices of the polygon.</param>
        /// <returns>A new <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D"/> instance if a valid <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> is provided and there are at least three non-null <see cref="Point2D"/> points; otherwise, null.</returns>
