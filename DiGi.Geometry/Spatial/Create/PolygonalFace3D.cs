...
namespace DiGi.Geometry.Spatial
{
    ...
    {
        /// <summary>
        /// Converts a <see cref="Planar{T}"/> to a <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> if the conversion is successful; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> based on the specified <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> and a collection of <see cref="Point2D"/> vertices.
        /// </summary>
        /// <param name="plane">The <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> on which the polygonal face is located.</param>
        /// <param name="points">An array of <see cref="Point2D"/> objects defining the vertices of the polygon.</param>
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> instance if the <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> and <see cref="Point2D"/> array are not null and contain at least three points; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> based on an external boundary and optional internal boundaries.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> object if the face could be created; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Converts an <see cref="IPolygonalFace3D"/> instance to a <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> instance if the underlying plane is a <see cref="DiGi.Geometry.Spatial.Classes.Plane"/> and the geometry is an <see cref="IPolygonalFace2D"/>.
        /// </summary>
        /// <param name="polygonalFace3D">The <see cref="IPolygonalFace3D"/> instance to convert.</param>
        /// <returns>A new <see cref="DiGi.Geometry.Spatial.Classes.PolygonalFace3D"/> instance if the conversion is successful; otherwise, <see langword="null"/>.</returns>
