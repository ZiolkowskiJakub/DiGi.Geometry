...
namespace DiGi.Geometry.Spatial
{
    ...
    {
        /// <summary>
        /// Generates a <see cref="Mesh3D"/> from the specified <see cref="Ellipsoid"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="Mesh3D"/> representing the ellipsoid, or <c>null</c> if the provided <see cref="Ellipsoid"/> is <c>null</c>.</returns>
        ...
        /// <summary>
        /// Generates a <see cref="Mesh3D"/> from the specified <see cref="Ellipsoid"/> using an angle factor to determine the resolution of stacks and slices.
        /// </summary>
        ...
        /// <returns>A <see cref="Mesh3D"/> object representing the ellipsoid, or <c>null</c> if the provided <see cref="Ellipsoid"/> is <c>null</c>.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="Mesh3D"/> from a collection of <see cref="Triangle3D"/> objects.
        /// </summary>
        ...
        /// <returns>A <see cref="Mesh3D"/> object if the input collection is not null and contains valid triangles; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Converts the specified <see cref="Polyhedron"/> to a <see cref="Mesh3D"/> by triangulating its polygonal faces.
        /// </summary>
        /// <param name="polyhedron">The <see cref="Polyhedron"/> instance to convert.</param>
        /// <param name="tolerance">The <see cref="double"/> tolerance used during the triangulation of the polygonal faces.</param>
        /// <returns>A <see cref="Mesh3D"/> object representing the triangulated mesh, or <c>null</c> if the <see cref="Polyhedron"/> is null or contains no valid faces.</returns>
        ...
        /// <returns>A <see cref="Mesh3D"/> object representing the polygonal face, or <c>null</c> if the input is <c>null</c>.</returns>
